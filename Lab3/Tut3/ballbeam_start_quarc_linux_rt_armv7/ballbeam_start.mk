###########################################################################
## Makefile generated for component 'ballbeam_start'. 
## 
## Makefile     : ballbeam_start.mk
## Generated on : Mon Mar 11 16:41:29 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ballbeam_start.rt-linux_rt_armv7
...
PRODUCT_NAME              = ballbeam_start
MAKEFILE                  = ballbeam_start.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/bowen/OneDrive/DOCUME~1/School/WINTER~2/3TB4/Lab/Lab3/Tut3
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
QUARC_SYS_LIBS      = -lrt -lpthread -ldl -lm
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ballbeam_start.rt-linux_rt_armv7
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/ballbeam_start_quarc_linux_rt_armv7 -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/PROGRA~1/Quanser/QUARC/include
...
DEFINES_STANDARD = -DMODEL=ballbeam_start -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/ballbeam_start_quarc_linux_rt_armv7/ballbeam_start.c $(START_DIR)/ballbeam_start_quarc_linux_rt_armv7/ballbeam_start_data.c $(START_DIR)/ballbeam_start_quarc_linux_rt_armv7/ballbeam_start_main.c $(START_DIR)/ballbeam_start_quarc_linux_rt_armv7/rtGetInf.c $(START_DIR)/ballbeam_start_quarc_linux_rt_armv7/rtGetNaN.c $(START_DIR)/ballbeam_start_quarc_linux_rt_armv7/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = ballbeam_start.o ballbeam_start_data.o ballbeam_start_main.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_sim.o ext_svr.o updown.o ext_work.o
...
%.o : $(START_DIR)/ballbeam_start_quarc_linux_rt_armv7/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/ballbeam_start_quarc_linux_rt_armv7/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
ballbeam_start.o : $(START_DIR)/ballbeam_start_quarc_linux_rt_armv7/ballbeam_start.c
	$(CC) $(CFLAGS) -o"$@" "$<"


ballbeam_start_data.o : $(START_DIR)/ballbeam_start_quarc_linux_rt_armv7/ballbeam_start_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


ballbeam_start_main.o : $(START_DIR)/ballbeam_start_quarc_linux_rt_armv7/ballbeam_start_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetInf.o : $(START_DIR)/ballbeam_start_quarc_linux_rt_armv7/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/ballbeam_start_quarc_linux_rt_armv7/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/ballbeam_start_quarc_linux_rt_armv7/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"
